...
//this is my function that pushes objects. and handles the cases that exist. if needed we call to mulyplyTable.
int handleTable(Table *table, Object *object, int idx);
//func that multiply the table if needed
 int multiplyTable(Table *table, Object *object, int idx);
//a help function for strHashFun
 int sumascii(char str[], int num);
//a function that free list and calls freeObjects to help
